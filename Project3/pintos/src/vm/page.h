...
struct page
{
  ...
  struct vm_entry *vme;        /* vm_entry of virtual address */
  struct thread *thread;       /* Thread using corresponing physical address */
  struct list_elem lru;        /* List element for lru */
};
